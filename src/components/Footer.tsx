      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-primary-600 dark:text-luxury-dark-textSecondary mb-6 max-w-md mx-auto md:mx-0">
            ...
            <div className="flex justify-center md:justify-start space-x-4">
              {/* Facebook */}
              <a href="#" className="w-10 h-10 bg-primary-500 dark:bg-luxury-dark-accent rounded-full flex items-center justify-center text-white hover:bg-primary-600 dark:hover:bg-luxury-dark-accentHover transition-colors">
