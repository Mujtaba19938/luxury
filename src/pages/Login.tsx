        ...
        <div className="bg-white/60 backdrop-blur-md rounded-3xl p-8 shadow-xl border border-white/30">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input
                  type="checkbox"
                  className="w-4 h-4 text-[#c9ada7] bg-white/50 border-white/30 rounded focus:ring-[#c9ada7] focus:ring-2"
                />
                <span className="ml-2 text-sm font-['Inter'] text-[#9a8c98]">
                  Remember me
                </span>
              </label>
              <Link 
                to="/forgot-password" 
                className="text-sm font-['Inter'] text-[#c9ada7] hover:text-[#22223b] transition-colors duration-300"
              >
                Forgot password?
              </Link>
            </div>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white/60 text-[#9a8c98] font-['Inter']">Or continue with</span>
            </div>
          </div>

          {/* Social Login Buttons */}
          <div className="space-y-3">
            <button className="w-full flex items-center justify-center px-4 py-3 border border-white/30 rounded-xl bg-white/50 hover:bg-white/70 transition-all duration-300 font-['Inter'] text-[#22223b]">
