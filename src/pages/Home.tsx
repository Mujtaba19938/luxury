...
export default function Home() {
  ...
  return (
    <div className="relative">
      ...
      {/* Newsletter Section */}
      <section className="py-20 px-6 bg-gradient-to-br from-primary-50/50 via-primary-100/30 to-primary-200/50 dark:from-luxury-dark-bg/50 dark:via-luxury-dark-surface/30 dark:to-luxury-dark-surface/50">
        <div className="max-w-4xl mx-auto text-center">
